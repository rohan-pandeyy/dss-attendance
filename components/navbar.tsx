...
export function Navbar() {
  return (
    <header className="fixed inset-x-0 top-0 z-30 border-b border-input bg-background/80 backdrop-blur-md">
      <nav className="mx-auto flex h-12 w-full max-w-5xl items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium md:text-base">Data Science Society</span>
        </div>
        <Button asChild className="h-9 px-3 md:h-9 md:px-4">
